...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['BetterPsych'],
		['Classic1926',		'classic',		'Almost everything in this engine',					'https://www.youtube.com/channel/UCKcqlPIGcsoiGl9qsasAJhw',	0xFFFF3041],
		[''],
		['Psych Engine Team'],
	...
	override function update(elapsed:Float)
	{
		...
		if(controls.ACCEPT) {
			if (creditsStuff[curSelected][3] != '') // this should make that empty links won't open up the website
